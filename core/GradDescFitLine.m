function theta = GradDescFitLine(fhndl, x, y, varargin)
%
% theta = GradDescFitLine(fhndl, x, y, OPTIONS)
%
% GradDescFitLine performs a gradient descent to find the optimized set of parameters.
%
% INPUTS:
%
...
defaults = {[2*rand(1) - 1; 0], 0.1, 50, false, 0, 0};
