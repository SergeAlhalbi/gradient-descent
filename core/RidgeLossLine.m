function [yp, errVal, errGradVec] = RidgeLossLine(theta, x, y, varargin)
%
% [yp, errVal, errGradVec] = RidgeLossLine(theta, x, y, OPTIONS)
%
% RidgeLossLine computes the forward prediction using the current set of parameters,
...
errGradVec = (-2/numberOfPoints) .* [sum((y - yp).*x) ; sum(y - yp)];
